...
function percent(played, total) {
    return Math.round(100 * (played / total));
}

$(document).ready(function() {  
    $(".t-panel-2").hide();
    
    $(".t-pm-start-btn").on("click", function() {
        ...
        $(".t-item-display").text(listItemsRandom[0]);
        $(".t-streak").text("Streak: 0");
        
        var l = listItems.length;
        
        $(".t-correct").text("0/" + l + " correct");
        
        var n = 0;
        var streak = 0;
        var correct = 0;
        
        $(".t-correct-btn").on("click", function() {
            streak++;
            $(".t-streak").text("Streak: " + streak);
            
            correct++;
            $(".t-correct").text(correct + "/" + l + " correct");
            
            if (correct < l) {
                n++;
                $(".t-item-display").text(listItemsRandom[n]);
            } else if (correct === l) {
                $(".t-item-display").text("That's it! In total you played " + (n + 1) + " scales and got " + percent(l, (n + 1)) + "% of them correct!");
        ...
        $(".t-incorrect-btn").on("click", function() {
            streak = 0;
            $(".t-streak").text("Streak: " + streak);
            
            listItemsRandom.push(listItemsRandom[n]);
